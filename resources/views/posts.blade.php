...
@section('container')
        ...
        <div class="row align-items-stretch g-4">
            ...
            <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
                ...
                @if ($company && $company->logo)
                    <div>
                        <img src="{{ asset('storage/' . $company->logo) }}" class="logo-company" alt="logo">
                    </div>
                @endif
    ...
    @if ($post->image4)
        <div class="container-fluid px-0">
            <img src="{{ $post->image4 ? asset('storage/' . $post->image4) : 'https://picsum.photos/1280/720' }}"
    ...
    {{-- ================= CLIENT ================= --}}
    @php
        $hasClient = $post->videoeditby || $post->photoby || $post->aktor1 || $post->aktor2 || $post->aktor3;
    @endphp
